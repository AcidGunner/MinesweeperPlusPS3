...
if global.CONTROL==0
{
    ...
    //First config
    p2_start=gamepad_button_check_pressed(0,gp_start);
    p2_hstart=gamepad_button_check(0,gp_start);
    p2_select=gamepad_button_check(0,gp_select);
    p2_a=gamepad_button_check_pressed(0,gp_face1);
    p2_a_held=gamepad_button_check(0,gp_face1);
    p2_b=gamepad_button_check(0,gp_face2);
    p2_bl=gamepad_button_check_pressed(0,gp_face2);
    p2_c=gamepad_button_check_pressed(0,gp_face3);
    p2_c_held=gamepad_button_check(0,gp_face3);
    p2_d=gamepad_button_check_pressed(0,gp_face4);
    p2_d_held=gamepad_button_check(0,gp_face4);
    p2_l1=gamepad_button_check_pressed(0,gp_shoulderl);
    p2_r1=gamepad_button_check_pressed(0,gp_shoulderr);
    p2_l1h=gamepad_button_check(0,gp_shoulderl);
    p2_r1h=gamepad_button_check(0,gp_shoulderr);
    p2_l2=gamepad_button_check_pressed(0,gp_shoulderlb);
    p2_r2=gamepad_button_check_pressed(0,gp_shoulderrb);
    p2_l2h=gamepad_button_check(0,gp_shoulderlb);
    p2_r2h=gamepad_button_check(0,gp_shoulderrb);
    p2_any=gamepad_button_check_pressed_any(0);
    
    //Prepare the CONSOLE MOVEMENTS!!!!
    p2_stick_h=gamepad_axis_value(0,gp_axislh);
    p2_stick_v=gamepad_axis_value(0,gp_axislv);
    var p2_stick_rh=gamepad_axis_value(0,gp_axisrh);
    var p2_stick_rv=gamepad_axis_value(0,gp_axisrv);
    
    //Last config!
    p2_up=gamepad_button_check(0,gp_padu) or p2_stick_v<=-gmin;
    p2_down=gamepad_button_check(0,gp_padd) or p2_stick_v>=gmin;
    p2_right=gamepad_button_check(0,gp_padr) or p2_stick_h>=gmin;
    p2_left=gamepad_button_check(0,gp_padl) or p2_stick_h<=-gmin;
    p2_lef=gamepad_button_check_pressed(0,gp_padl) or (p2_stick_h<=-gmin && global.p2_prev_stick_h>-gmin);
    p2_rig=gamepad_button_check_pressed(0,gp_padr) or (p2_stick_h>=gmin && global.p2_prev_stick_h<gmin);
    p2_dow=gamepad_button_check_pressed(0,gp_padd) or (p2_stick_v>=gmin && global.p2_prev_stick_v<gmin);
    p2_upp=gamepad_button_check_pressed(0,gp_padu) or (p2_stick_v<=-gmin && global.p2_prev_stick_v>-gmin);
    ...
    p2_cursor_r=gamepad_button_check(0,gp_select);
    ...
    p2_mp1 = p2_a;
    p2_mk1 = p2_a_held;
    p2_mh1 = gamepad_button_check_released(0,gp_face1);
    p2_mp2 = p2_bl;
    p2_mh2 = gamepad_button_check_released(0,gp_face2);
}
